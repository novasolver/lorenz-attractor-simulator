...
[![Live demo](https://img.shields.io/badge/live-demo-blue)](https://novasolver.jp/tools/lorenz-attractor.html)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

Real-time 3D simulation of the Lorenz strange attractor. Explore chaos with σ, ρ, β parameters.

🌐 **[Try it live](https://novasolver.jp/tools/lorenz-attractor.html)** · 🌍 [EN](https://novasolver.jp/en/tools/lorenz-attractor.html) · 🌏 [ZH](https://novasolver.jp/zh/tools/lorenz-attractor.html)

---

## Why

Real-time 3D simulation of the Lorenz strange attractor. Explore chaos with σ, ρ, β parameters. Built as part of **[NovaSolver](https://novasolver.jp)** — 1600+ interactive physics & engineering simulators.
...
```bash
git clone https://github.com/novasolver/lorenz-attractor-simulator
